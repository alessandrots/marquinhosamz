...
class CameraFragment : Fragment() {
            ...
            capture.takePicture(
                ...
                object : ImageCapture.OnImageSavedCallback {
                    override fun onImageSaved(file: File) {
                        ...
                        //Toast.makeText(requireContext(), "CROP = " + path, Toast.LENGTH_LONG).show()
                        /**
    ...
    private fun saveImageORIGINAL(bytes: ByteArray) : String {
    ...
    private fun saveImage(bytes: ByteArray) : String {
        ...
        //var directoryName = File(Environment.getExternalStorageDirectory().toString() + IMAGE_DIRECTORY);

        val context = requireContext();
        //val path = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        val directoryName = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        var file = File(directoryName, fileName);
